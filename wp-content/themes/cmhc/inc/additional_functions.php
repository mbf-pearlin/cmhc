...
h1 a {background: url('.get_bloginfo('template_directory').'/assets/images/logo.png) no-repeat center !important; display: block; height: 90px !important; width: auto !important; }
.login,html{ background: #150e20 url('.get_bloginfo('template_directory').'/assets/images/backgala-img.jpg) repeat-x !important; background-position: center bottom !important; }
</style>';
}
